...
def test_scaffolds_download():
    ...
    cfdb = test_registry.genome('Cfhb')
...
def test_annotation_hymbase():
    ...
    db = test_registry.genome('Cfhb', workdir='testdata/demo-workdir')
    ...
    db = test_registry.genome('Sihb', workdir='testdata/demo-workdir')
    db.preprocess_gdna(logstream=None, verify=False)
    db.preprocess_gff3(logstream=None, verify=False)
...
def test_scaffolds_download_beebase():
    ...
    emex_db = test_registry.genome('Emex')
...
def test_annot_download():
    ...
    dnov_db = test_registry.genome('Dnov', workdir='BeeBase')
    testurl = ('http://hymenopteragenome.org/beebase/sites/'
               'hymenopteragenome.org.beebase/files/data/consortium_data/'
...
def test_proteins_download():
    ...
    hlab_db = test_registry.genome('Hlab', workdir='/opt/db/fidibus')
    testurl = ('http://hymenopteragenome.org/beebase/sites/'
               'hymenopteragenome.org.beebase/files/data/consortium_data/'
...
def test_gdna_format():
    ...
    db = test_registry.genome('Hlab', workdir='testdata/demo-workdir')
    db.preprocess_gdna(logstream=None, verify=False)
    ...
    db = test_registry.genome('Am32', workdir='testdata/demo-workdir')
    db.preprocess_gdna(logstream=None, verify=False)
