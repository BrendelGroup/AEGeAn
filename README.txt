...
email (daniel.standage@gmail.com). Even better, open up a thread on AEGeAn's
issue trackernso that I can share my response with others who may have the same
questions or issues.


Documentation
----------------------------------------
Full installation instructions are provided in docs/INSTALL. The example below
...
Comprehensive documentation for the AEGeAn Toolkit is coming soon! In the mean
time, each program provides a descriptive usage statement, and the C API is
documented in the header files located in the inc/core directory.


Publications
----------------------------------------
Daniel S. Standage and Volker P. Brendel (2012) ParsEval: parallel comparison
